...
export default function EmailDetailPageContent({ email, user }: EmailDetailPageContentProps) {
          ...
          <div className="max-w-5xl w-full mx-auto">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="px-6 py-4 flex items-start gap-3">
                <div className="shrink-0 w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center text-white text-sm font-medium">
